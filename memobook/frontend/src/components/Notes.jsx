...
const Notes = (props) => {
  ...
  const handleClick = (e) => {
    e.preventDefault();
    editNote(note.id, note.etitle, note.edescription, note.etag, note.ename);
      ...
      <div className="container mt-5 row text-light">
        <div className="d-flex justify-content-center">
         ...
         <div> <h1>Your Notes</h1>
          <h6>~You can view your notes here</h6>
          <h6>~You can update your notes</h6>
          <h6>~You can delete your notes as well</h6>
          </div>
        </div>
